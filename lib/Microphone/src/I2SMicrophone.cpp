...
I2SMicrophone::I2SMicrophone(int dataPin, int clockPin, int wordSelectPin, 
                           i2s_port_t i2sPort, bool isPDM)
    : _dataPin(dataPin), _clockPin(clockPin), _wsPin(wordSelectPin),
      _i2sPort(i2sPort), _isPDM(isPDM), _initialized(false),
...
bool I2SMicrophone::configureI2S() {
    ...
    if (_isPDM) {
        ...
        // Standard I2S microphone configuration
        i2s_config = {
    ...
    if (_isPDM) {
        // PDM microphone pin configuration
        pin_config = {
        ...
        // Standard I2S microphone pin configuration
        pin_config = {
            .bck_io_num = _clockPin,
            .ws_io_num = _wsPin,
            .data_out_num = I2S_PIN_NO_CHANGE,
